...
\fancyhead[R]{\small\color{gray}Design Document\,---\,v34}
...
\begin{titlepage}
  ...
  \vspace{1.2cm}
  {\large\bfseries\color{midblue} Revision v34\par}
  \vspace{0.2cm}
  {\small\color{gray} Replaces v33 Tier-2 force with Einstein--Infeld--Hoffmann 1PN equation
  (sign fix on velocity-coupling term, adds Shapiro $4\Phi_g\vec g/c^2$ term);
  adds analytic-background evaluation mode (point mass; spinning / charged variants reserved).\par}
  \vspace{1.5cm}
  \hrule
\end{titlepage}
...
\textbf{Einstein--Infeld--Hoffmann (EIH) equation}, the standard
...
(e.g.\ Ali-Ha\"\i moud, ``Introduction to the post-Newtonian expansion'',
NYU GR Fall 2019 Lecture~25, eq.~37).  The sign error was confirmed
