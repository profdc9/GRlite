...
$q\,\vv{v}\!\times\!\vv{B}$ term.  The $-q\nabla\phi$ scalar (Coulomb)
term and the $-q\,\partial_t\vv{A}$ inductive term are not yet wired
into the pusher; they will land with the static-Coulomb verification
stage (analog of Stage~3 Poisson for EM) and the radiative-EM stage
respectively.  Until then, charged particles in a non-magnetic EM
background feel no EM force.  This was a conscious scope cut to keep
the present verification focused on the curl-evaluator chain shared
with the GEM side.
